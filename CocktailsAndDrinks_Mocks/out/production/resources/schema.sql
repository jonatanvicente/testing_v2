CREATE TABLE clientes (
  ID_CLIENTES INTEGER IDENTITY PRIMARY KEY,
...
CREATE TABLE tipos_proveedores (
  ID_TIPO_PROVEEDOR INTEGER IDENTITY PRIMARY KEY,
  TIPO_PROVEEDOR VARCHAR(45) NOT NULL);


CREATE TABLE tipos_vinos (
  ID_VINO INTEGER IDENTITY PRIMARY KEY,
  CATEGORIA VARCHAR(45) NOT NULL);
  
  
CREATE TABLE empleados (
  ID_EMP INTEGER IDENTITY PRIMARY KEY,
...
CREATE TABLE pedidos (
  ID_SOLICITUD INTEGER IDENTITY PRIMARY KEY,
